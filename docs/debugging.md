...
![G-Wn7Seyn](assets/debugging/G-Wn7Seyn.gif)
...
![ddqvW2927](assets/debugging/ddqvW2927.png)
...
When googling, a good idea is to be as detailed as possible in the search. Following the previous example, I'd use "_javascript ReferenceError: Cannot access before initialization_". I've found that mentioning the technology you're using in the search gives you more accurate results.
...
![lwjv2jUhM](assets/debugging/lwjv2jUhM.png)
...
![aEKNV-Iju](assets/debugging/aEKNV-Iju.gif)
...
![Ly_kXFJop](assets/debugging/Ly_kXFJop.gif)
...
![xOmnh7_G7](assets/debugging/xOmnh7_G7.gif)
...
![Y4PKO37NS](assets/debugging/Y4PKO37NS.png)
...
![TYPESCRIPT1](assets/debugging/TYPESCRIPT1.png)
...
![vsc1](assets/debugging/vsc1.png)

After that, we'll be presented with the following screen:

![vsc2](assets/debugging/vsc2.png)
...
![vsc5](assets/debugging/vsc5.png)
...
![vsc6](assets/debugging/vsc6.png)
...
![vsc7](assets/debugging/vsc7.png)
...
![vsc8](assets/debugging/vsc8.png)
...
![vsc9](assets/debugging/vsc9.jpg)
...
![chrome1](assets/debugging/chrome1.png)
...
![chrome2](assets/debugging/chrome2.png)
...
![chrome3](assets/debugging/chrome3.png)
